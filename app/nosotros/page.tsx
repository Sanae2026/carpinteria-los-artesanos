      ...
      <section className="max-w-6xl mx-auto px-6 py-16 grid grid-cols-2 gap-16">
        <div>
          ...
          <p className="text-stone-500 font-light leading-relaxed mb-4">
           Fundado en 1996 por Manuel Artigas en el barrio del Centro de Almería, Los Artesanos nació con una misión clara: devolver el valor a la madera trabajada a mano en un mundo que apostaba por la producción en serie.
          </p>
          <p className="text-stone-500 font-light leading-relaxed mb-4">
            Hoy, con su hijo Diego al frente del taller, combinamos el respeto por las técnicas tradicionales con herramientas de precisión modernas para ofrecer piezas que duran generaciones bajo el sol del Mediterráneo.
          </p>
